...
export default function Rectangle({ icon, title, text, className, width }: RectangleProps) {
    return (
        <span className={`w-1/3 h-[250px] lg:w-[30%] lg:h-auto xl:w-[300px] xl:h-[300px] bg-[#212121] rounded-[30px] lg:rounded-[30px] xl:rounded-[30px] pt-9 px-2 lg:px-4 pb-5 flex flex-col items-center relative shadow-[0_1px_0_rgba(0,0,0,0.03)] overflow-visible font-sans ${className ?? ""}`}>
            ...
            <div className={`flex flex-col items-center lg:mt-2 xl:mt-4 text-center ${width ? width : 'w-full lg:w-[100%] xl:w-[85%]'}`}>
